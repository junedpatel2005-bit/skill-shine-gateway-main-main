...
const isPrismaConfigured = () => Boolean(getConfiguredDatabaseUrl());
const getPrismaInitError = () => prismaInitError;
...
function healthResponse() {
  ...
  return Response.json({
    ...
    prismaError: prismaError instanceof Error ? prismaError.message : prismaError ? String(prismaError) : void 0,
